...
Hey Guys ❤, we DSC GGV has conducted the [Hacktober Fest-2020](https://hacktoberfest.digitalocean.com/). So still if you have any Projects regarding Android or Web based technology or you want to modify/resolve(any bugs) of previous Projects then you to follow the Contribution Guidelines.
...
- **Step 2** - Clone the repository to your local machine. ```(_git clone_)```
...
<table>
  ...
  <td>
   <a href="https://github.com/Abhijit2505">abhishekapk</a>
  </td>
    <td>
      <a href="https://www.linkedin.com/in/abhishekapk/">Abhishek Kumar Gupta</a>
  </td>
